...
In Kubernetes, **Autoscaling (HPA, VPA, KEDA)** represents fundamental declarative resources managed through continuous control loops. 
...
kubectl get autoscaling -o wide

# 2. Inspect detailed control plane events and controller messages
kubectl describe autoscaling <resource-name>
...
<div style="margin-top: 1.5rem;">
  <a href="../playground/index.html?chapter=11" class="md-button md-button--primary">
    ⚡ Practice Chapter 11 in WebAssembly Playground →
  </a>
</div>
