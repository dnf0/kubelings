...
In Kubernetes, **Controllers & Replication** represents fundamental declarative resources managed through continuous control loops. 
...
kubectl get controllers -o wide

# 2. Inspect detailed control plane events and controller messages
kubectl describe controllers <resource-name>
...
<div style="margin-top: 1.5rem;">
  <a href="../playground/index.html?chapter=2" class="md-button md-button--primary">
    ⚡ Practice Chapter 02 in WebAssembly Playground →
  </a>
</div>
